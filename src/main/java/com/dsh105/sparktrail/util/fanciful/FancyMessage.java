 ...
 */
package com.dsh105.sparktrail.util.fanciful;

import com.dsh105.sparktrail.util.ReflectionUtil;
import com.dsh105.sparktrail.util.protocol.wrapper.WrapperPacketChat;
import com.dsh105.sparktrail.util.reflection.SafeConstructor;
import com.dsh105.sparktrail.util.reflection.SafeField;
...
public class FancyMessage {
      ...
      public FancyMessage itemTooltip(final ItemStack itemStack) {
            Object nmsCopy = new SafeMethod(ReflectionUtil.getCBCClass("inventory.CraftItemStack"), "asNMSCopy", ItemStack.class).invoke(null, itemStack);
      ...
      public void send(Player player) {
            WrapperPacketChat chat = new WrapperPacketChat();
