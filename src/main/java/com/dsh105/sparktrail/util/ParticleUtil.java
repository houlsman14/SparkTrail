...
public class ParticleUtil {
      ...
      public static WrapperPacketWorldParticles createPacket(WrapperPacketWorldParticles.ParticleType type, Location location) {
            return createPacket(type, location, r());
      }

      public static WrapperPacketWorldParticles createPacket(WrapperPacketWorldParticles.ParticleType type, Location location, Vector offset) {
            return createPacket(type, location, offset, type.getDefaultSpeed(), type.getDefaultAmount());
      }

      public static WrapperPacketWorldParticles createPacket(WrapperPacketWorldParticles.ParticleType type, Location location, Vector offset, float speed, int amount) {
            return createPacket(type.getName(), location, offset, speed, amount);
      }

      public static WrapperPacketWorldParticles createPacket(String name, Location location) {
      ...
      public static WrapperPacketWorldParticles createPacket(String name, Location location, Vector offset, float speed, int amount) {
